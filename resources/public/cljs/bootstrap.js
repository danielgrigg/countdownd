...
clojure.browser.dom._element = function() {
  var a = null, b = function(a) {
    if(a ? a.clojure$browser$dom$DOMBuilder$_element$arity$1 : a) {
      a = a.clojure$browser$dom$DOMBuilder$_element$arity$1(a)
    }else {
      var b;
      b = clojure.browser.dom._element[goog.typeOf(a)];
    ...
    if(a ? a.clojure$browser$dom$DOMBuilder$_element$arity$2 : a) {
      c = a.clojure$browser$dom$DOMBuilder$_element$arity$2(a, b)
    }else {
      c = clojure.browser.dom._element[goog.typeOf(a)];
    ...
    if(a ? a.clojure$browser$dom$DOMBuilder$_element$arity$3 : a) {
      a = a.clojure$browser$dom$DOMBuilder$_element$arity$3(a, b, c)
    }else {
      var d;
      d = clojure.browser.dom._element[goog.typeOf(a)];
...
countdownd.hello.log_obj = function(a) {
  return console.log(a)
};
